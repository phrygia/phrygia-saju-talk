...
export default function PrivacyPolicy() {
  return (
    <>
      <div className="min-h-screen bg-background px-4 pt-6 pb-20 md:pb-10 sm:px-6 lg:px-8">
          ...
          <div className="space-y-12 text-foreground-sub">
            ...
            <section>
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  <strong>전자파일 형태:</strong> 복구 및 재생이 불가능한
                  방법으로 영구 삭제
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  법령에서 명시하거나 수사 목적으로 법령이 정한 절차와 방법에
                  따라 수사기관의 요구가 있는 경우
                </li>
              </ul>
            </section>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="mb-2">
                    ...
                    있습니다. 단, 쿠키 거부 시 일부 서비스 이용에 불편함이 있을
                    수 있습니다.
                  </p>
            ...
            <section>
              ...
              <p className="mb-3">
                iOS 앱 이용 시, 애플의 앱 추적 투명성(ATT) 정책에 따라 맞춤형
                광고 제공을 위한 기기 추적 동의를 별도로 요청합니다.
              </p>
              <ul className="list-disc space-y-2 pl-6">
                <li>
                  <strong>추적 허용 시:</strong> 광고 식별자(IDFA)를 활용한
                  맞춤형 광고가 제공됩니다.
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc space-y-2 pl-6">
                <li>
                  <strong>관리적 조치:</strong> 개인정보 처리 직원 최소화 및
                  정기 교육
                </li>
                <li>
            ...
            <section>
              ...
              <p className="mb-3">
                ...
                관련한 이용자의 불만 처리 및 피해 구제를 위해 아래와 같이
            ...
            <section>
              ...
              <p>
                본 개인정보처리방침은 법령의 변경이나 서비스 개선에 따라 변경될
                수 있습니다. 변경 시 시행 7일 전부터 앱 내 공지사항 또는
                웹사이트를 통해 사전 공지하겠습니다. 다만, 이용자 권리에 중대한
                변경이 발생할 경우 30일 전에 공지합니다.
              </p>
            </section>
          </div>
